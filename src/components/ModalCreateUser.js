      ...
      <div>
        ...
        <Modal show={show} onHide={handleClose} size="xl" >
          ...
          <Modal.Body>
                ...
                <Form.Label>Setor</Form.Label>
                 ...
                 <Form.Label>Tipo de Solicitação</Form.Label>
                  <Form.Select name="solicitacao" onChange={handleChange}>
                    ...
                    <option value="Configurar Software ">Configurar Software </option>                    
                    <option value="Instalar PacoteOffice">Instalar Pacote Office</option>
                    <option value="Formatar Computador">Formatar Computador</option>
                    <option value="Instalar Impressora">Instalar impressora</option>
              ...
              <Col>
              <Form.Group>
              <Form.Label>Por favor, informe detalhes da solicitação:</Form.Label>
                   <br/> 
                   <Form.Control  type="text"name="obsSolicitacao"
